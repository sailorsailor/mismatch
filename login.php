<?php
	...
	if (!isset($_SERVER['PHP_AUTH_USER']) || !isset($_SERVER['PHP_AUTH_PW'])) {
		...
		exit('<h3>Mismatch</h3>Sorry, you must enter your username and password to log in and '.
			'access this page. If you aren\'t a registered member, please <a href="signup.php">'.
			'Sign Up</a>.');
	}
	...
	if (mysqli_num_rows($data) == 1) {
		...
		header('HTTP/1.1 401 Unauthorized');
		header('WWW-Authenticate: Basic realm="Mismatch"');
		exit('<h2>Mismatch</h2>Sorry, you must enter a valid username and password to log in '.
			'and access this page. If you aren\'t a registered member, please <a href="signup.php">'.
			'Sign Up</a>.');
	}
